...
(function (global) {
  ...
  function _layoutOptsForBand(band) {
    ...
    var BANDS = [
      { band: 0, cls: 'aig-zoom-far',  cardW: 150, xGap: 40, asks: false, finds: false, chain: false, followups: false, run: false },
      { band: 1, cls: 'aig-zoom-mid',  cardW: 210, xGap: 64, asks: true,  finds: true,  chain: false, followups: false, run: true  },
      { band: 2, cls: 'aig-zoom-near', cardW: 320, xGap: 72, asks: true,  finds: true,  chain: true,  followups: true,  run: true  },
    ];
    return BANDS[b];
  }
