...
- [ ] [52: V2 Chain-dispatch Lineage Wall Time Under 5min](./52.md#goal)
- [ ] [53: Streamline Chain-dispatch Job Cancellation](./53.md#goal)
- [ ] [54: Workspace Build-switch Session Identity Mismatch](./54.md#goal)
- [ ] [55: Stale batch_baseline Composite ID After v2ecoli Refactor](./55.md#goal)
- [ ] [56: Quantity._serialize_state Missing Float Branch](./56.md#goal)