...
- [x] [47: Dark/light mode theme switcher, with selectable-themes feasibility assessment](./47.md#goal) — binary coverage completed + verified live, PR #869 open, not merged; N-theme system deliberately deferred (needs a token-consolidation pass first, per the item's own recommendation)
