...
def _v2e_observables_or_skip():
    ...
    try:
        from vivarium_workbench.lib.readout_validation import available_observables  # noqa: F401
    except Exception:
        pytest.skip("vivarium_workbench.lib.readout_validation unavailable")
