...
identical to the canonical viva_superpowers/viz_freshness.py.
...
CANONICAL = Path(__file__).parent.parent.parent / "pbg-superpowers" / "viva_superpowers" / "viz_freshness.py"
